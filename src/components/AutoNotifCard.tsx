    ...
    <div className="bg-card border border-line rounded-2xl p-3">
      <div className="flex gap-2.5">
        ...
        <div className="flex-1 min-w-0">
          <div className="font-bold text-ink text-[12px]">
          ...
          {open && (
            <div className="mt-2 pt-2 border-t border-dashed border-line space-y-1">
              {sub.quiz_json?.map((q, i) => (
                <div key={i} className="flex items-center gap-1.5 text-[10.5px] font-semibold text-ink-soft">
