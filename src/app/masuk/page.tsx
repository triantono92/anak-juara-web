...
export default function MasukPage() {
  ...
  const handleMasuk = async (e: React.FormEvent) => {
    ...
    // Cek role dari app_users untuk menentukan redirect
    ...
    if (res.ok) {
      ...
      setErr("Akun ditemukan tapi profil belum lengkap. Hubungi orang tua.");
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-page-bg px-5 py-8">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="bg-white rounded-3xl p-6 card-shadow">
          <h2 className="font-display font-bold text-navy text-xl mb-5">Masuk</h2>
